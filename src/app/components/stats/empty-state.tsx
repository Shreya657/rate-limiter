...
export function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] p-8 text-center border-2 border-dashed rounded-xl border-muted-foreground/20">
      ...
      <h3 className="text-xl font-semibold text-white">No Traffic Detected</h3>
      ...
      <div className="mt-6 p-4 bg-zinc-950 rounded-lg  overflow-x-auto w-full max-w-md ">
        <code className="text-xs text-center text-teal-400">
          curl -X POST https://rate-limiter-swart.vercel.app/api/v1/verify \<br/>
